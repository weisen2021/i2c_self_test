...
//在AT24CXX或FM24C里面的指定地址开始写入长度为Len的数据
...
//在AT24CXX或FM24C里面的指定地址开始读出长度为Len的数据
...
//在AT24CXX或FM24C里面的指定地址开始读出指定个数的数据
...
//在AT24CXX或FM24C里面的指定地址开始写入指定个数的数据

...
uint8_t E2Prom_Test_Write[] = {0x04, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x0A};
...
static void i2c_test_task(void *arg)
{
    while (1)
    {
        ...
        vTaskDelay(10 / portTICK_PERIOD_MS);
        E2P_Read(PRODUCT_ID_ADDR, E2Prom_Test_Read1, 9);
        ESP_LOGE(TAG, "%d", __LINE__);
...
void app_main(void)
{
    ...
    xTaskCreate(i2c_test_task, "i2c_test_task_0", 1024 * 2, NULL, 2, NULL);
    xTaskCreate(app_uart_task, "uart_task", 4096, NULL, 1, NULL);
}
